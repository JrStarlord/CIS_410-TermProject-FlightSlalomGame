...
{
    public float forwardSpeed = 1000f, strafeSpeed = 700f, hoverSpeed = 500f;
    ...
    void Update()
    {
        ...
        activeHoverSpeed = Mathf.Lerp(activeHoverSpeed, Input.GetAxisRaw("Hover") * hoverSpeed, hoverAccelereatoin * Time.deltaTime);
